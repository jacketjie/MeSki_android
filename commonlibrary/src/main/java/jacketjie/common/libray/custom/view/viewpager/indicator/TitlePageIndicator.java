 ...
 */
package jacketjie.common.libray.custom.view.viewpager.indicator;
...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // mCurrentPage is -test_1 on first start and after orientation changed. If so, retrieve the correct index from viewpager.
