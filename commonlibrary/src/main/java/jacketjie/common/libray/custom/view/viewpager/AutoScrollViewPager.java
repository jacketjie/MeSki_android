...
import jacketjie.common.libray.custom.view.viewpager.utils.CustomDurationScroller;
...
public class AutoScrollViewPager extends ViewPager {
    ...
    private double autoScrollFactor = 1;
    /** scroll factor for swipe scroll animation, default is 1.0 **/
    private double swipeScrollFactor = 1;
...
//			mDistance = ev.getY() - currentDownY;
//			break;
...
//				/**
//				 * current index is first one and slide to right or current
//				 * index is last one and slide to left.<br/>
//				 * if slide border mode is to parent, then
//				 * requestDisallowInterceptTouchEvent false.<br/>
//				 * else scroll to last one when current item is first one,
//				 * scroll to first one when current item is last one.
//				 */
